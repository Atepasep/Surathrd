													...
													<div class="col-md-7">
														<select class="form-control input-sm" name="jnsurat" id="jnsurat">
															...
															<?php foreach ($jeniscuti->result_array() as $jencut) : if ($this->session->userdata('kel') == 'L' && $jencut['kode'] == 'CH') { ?>
																	<option value="<?= $jencut['kode'] ?>" <?php if ($jencut['kode'] == $jncuti) {
																												echo "selected";
																											} ?> style="display: none;"><?= $jencut['keterangan'] ?></option>
																<?php } else { ?>
																	<option value="<?= $jencut['kode'] ?>" <?php if ($jencut['kode'] == $jncuti) {
																												echo "selected";
																											} ?>><?= $jencut['keterangan'] ?></option>
															<?php }
															endforeach; ?>
														</select>
													</div>
														...
														<div class="form-group" id="formjncuti">
															...
															<div class="col-md-8">
																<select class="form-control input-sm" name="jncuti" id="jncuti" name="jncuti">
																	<option value="">--Pilih--</option>
																	<option value="1" <?php if ($ambil == 1) {
																							echo 'selected';
																						} ?>>Ambil Cuti</option>
																	<option value="2" <?php if ($ambil == 2) {
																							echo 'selected';
																						} ?>>Tidak ambil Cuti</option>
																</select>
															</div>
														</div>
