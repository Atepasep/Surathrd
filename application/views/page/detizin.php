				...
				<div class="panel-body pan">
					<div class="row">
						...
						<div class="col-sm-6" style="text-align: right;">
							<a href="#" class="btn btn-sm btn-danger" id="isisemuaapprove" data-href="<?= base_url().'izin/approvesemuadata' ?>" data-news="Yakin anda akan menyetujui semua data ?" data-target="#confirm-task" data-remote="false" data-toggle="modal" data-title="Approve Data"><i class="fa fa-check"></i> Approve Semua</a>
						</div>
					</div>
					<div class="row">
						<div class="col-sm-12">
