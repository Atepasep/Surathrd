...
class M_absen extends CI_Model
{
	...
	public function getdataabsen()
	{
		...
		$query = $this->db->query("SELECT a.*,b.valid,b.rilis,b.nama,b.bagian,b.grp,c.keterangan as keterangan FROM ketabsen a
		LEFT JOIN mperson b ON CONCAT(b.kritkar,b.person_id) = CONCAT(a.kritkar,a.person_id)
		LEFT JOIN jeniscuti c ON c.kode = a.jnabsen
